...
var jsAudioRecorderExports = {};
var jsAudioRecorder = {
  get exports() {
    return jsAudioRecorderExports;
  },
  set exports(v2) {
    jsAudioRecorderExports = v2;
  }
};
var recorderExports = {};
var recorder = {
  get exports() {
    return recorderExports;
  },
  set exports(v2) {
    recorderExports = v2;
  }
  ...
  !function(t2, e2) {
    ...
    return function(t2) {
      ...
      function n2(i2) {
        ...
        return t2[i2].call(o2.exports, o2, o2.exports, n2), o2.l = true, o2.exports;
      }
      ...
      function i2(t3, e3, n3) {
        for (var i3 = 0; i3 < n3.length; i3++)
          t3.setUint8(e3 + i3, n3.charCodeAt(i3));
      }
      Object.defineProperty(e2, "__esModule", { value: true }), e2.compress = function(t3, e3, n3) {
        for (var i3 = e3 / n3, o2 = Math.max(i3, 1), r2 = t3.left, a2 = t3.right, s2 = Math.floor((r2.length + a2.length) / i3), u2 = new Float32Array(s2), c2 = 0, l2 = 0; c2 < s2; ) {
          var f2 = Math.floor(l2);
          u2[c2] = r2[f2], c2++, a2.length && (u2[c2] = a2[f2], c2++), l2 += o2;
        }
        return u2;
      }, e2.encodePCM = function(t3, e3, n3) {
        void 0 === n3 && (n3 = true);
        var i3 = 0, o2 = t3.length * (e3 / 8), r2 = new ArrayBuffer(o2), a2 = new DataView(r2);
        if (8 === e3)
          for (var s2 = 0; s2 < t3.length; s2++, i3++) {
            var u2 = (c2 = Math.max(-1, Math.min(1, t3[s2]))) < 0 ? 128 * c2 : 127 * c2;
            u2 = +u2 + 128, a2.setInt8(i3, u2);
          }
        else
          for (s2 = 0; s2 < t3.length; s2++, i3 += 2) {
            var c2 = Math.max(-1, Math.min(1, t3[s2]));
            a2.setInt16(i3, c2 < 0 ? 32768 * c2 : 32767 * c2, n3);
          }
        return a2;
      }, e2.encodeWAV = function(t3, e3, n3, o2, r2, a2) {
        void 0 === a2 && (a2 = true);
        var s2 = n3 > e3 ? e3 : n3, u2 = r2, c2 = new ArrayBuffer(44 + t3.byteLength), l2 = new DataView(c2), f2 = o2, p2 = 0;
        i2(l2, p2, "RIFF"), p2 += 4, l2.setUint32(p2, 36 + t3.byteLength, a2), i2(l2, p2 += 4, "WAVE"), i2(l2, p2 += 4, "fmt "), p2 += 4, l2.setUint32(p2, 16, a2), p2 += 4, l2.setUint16(p2, 1, a2), p2 += 2, l2.setUint16(p2, f2, a2), p2 += 2, l2.setUint32(p2, s2, a2), p2 += 4, l2.setUint32(p2, f2 * s2 * (u2 / 8), a2), p2 += 4, l2.setUint16(p2, f2 * (u2 / 8), a2), p2 += 2, l2.setUint16(p2, u2, a2), i2(l2, p2 += 2, "data"), p2 += 4, l2.setUint32(p2, t3.byteLength, a2), p2 += 4;
        for (var d2 = 0; d2 < t3.byteLength; )
          l2.setUint8(p2, t3.getUint8(d2)), p2++, d2++;
        return l2;
      };
    }, function(t2, e2, n2) {
      var i2, o2 = this && this.__extends || (i2 = function(t3, e3) {
      ...
      var r2 = n2(2), a2 = n2(0), s2 = n2(3), u2 = function(t3) {
        function e3(e4) {
          void 0 === e4 && (e4 = {});
          var n3 = t3.call(this, e4) || this;
          return n3.isrecording = false, n3.ispause = false, n3.isplaying = false, n3;
        }
        return o2(e3, t3), e3.prototype.setOption = function(t4) {
          void 0 === t4 && (t4 = {}), this.setNewOption(t4);
          ...
          this.stop(), this.isplaying = true, this.onplay && this.onplay(), s2.default.addPlayEnd(this.onplayend);
          var t4 = this.getWAV();
          t4.byteLength > 44 && s2.default.play(t4.buffer);
        }, e3.prototype.getPlayTime = function() {
          return s2.default.getPlayTime();
        }, e3.prototype.pausePlay = function() {
          !this.isrecording && this.isplaying && (this.isplaying = false, this.onpauseplay && this.onpauseplay(), s2.default.pausePlay());
        }, e3.prototype.resumePlay = function() {
          this.isrecording || this.isplaying || (this.isplaying = true, this.onresumeplay && this.onresumeplay(), s2.default.resumePlay());
        }, e3.prototype.stopPlay = function() {
          this.isrecording || (this.isplaying = false, this.onstopplay && this.onstopplay(), s2.default.stopPlay());
        }, e3.prototype.destroy = function() {
          return s2.default.destroyPlay(), this.destroyRecord();
        }, e3.prototype.getRecordAnalyseData = function() {
          return this.getAnalyseData();
        }, e3.prototype.getPlayAnalyseData = function() {
          return s2.default.getAnalyseData();
        }, e3.prototype.getPCM = function() {
          this.stop();
          var t4 = this.getData();
          return t4 = a2.compress(t4, this.inputSampleRate, this.outputSampleRate), a2.encodePCM(t4, this.oututSampleBits, this.littleEdian);
        }, e3.prototype.getPCMBlob = function() {
          return new Blob([this.getPCM()]);
        }, e3.prototype.downloadPCM = function(t4) {
          void 0 === t4 && (t4 = "recorder");
          var e4 = this.getPCMBlob();
          r2.downloadPCM(e4, t4);
        }, e3.prototype.getWAV = function() {
          var t4 = this.getPCM();
          return a2.encodeWAV(t4, this.inputSampleRate, this.outputSampleRate, this.config.numChannels, this.oututSampleBits, this.littleEdian);
        }, e3.prototype.getWAVBlob = function() {
          return new Blob([this.getWAV()], { type: "audio/wav" });
        }, e3.prototype.downloadWAV = function(t4) {
          void 0 === t4 && (t4 = "recorder");
          var e4 = this.getWAVBlob();
          r2.downloadWAV(e4, t4);
        }, e3.prototype.download = function(t4, e4, n3) {
          r2.download(t4, e4, n3);
        }, e3.prototype.getChannelData = function() {
          var t4 = this.getPCM(), e4 = t4.byteLength, n3 = this.littleEdian, i3 = { left: null, right: null };
          if (2 === this.config.numChannels) {
            var o3 = new DataView(new ArrayBuffer(e4 / 2)), r3 = new DataView(new ArrayBuffer(e4 / 2));
            if (16 === this.config.sampleBits)
              for (var a3 = 0; a3 < e4 / 2; a3 += 2)
                o3.setInt16(a3, t4.getInt16(2 * a3, n3), n3), r3.setInt16(a3, t4.getInt16(2 * a3 + 2, n3), n3);
            else
              for (a3 = 0; a3 < e4 / 2; a3 += 2)
                o3.setInt8(a3, t4.getInt8(2 * a3)), r3.setInt8(a3, t4.getInt8(2 * a3 + 1));
            i3.left = o3, i3.right = r3;
          } else
            i3.left = t4;
          return i3;
        }, e3;
      ...
      function i2(t3, e3, n3) {
        ...
        i3.href = window.URL.createObjectURL(t3), i3.download = e3 + "." + n3, i3.click();
      }
      Object.defineProperty(e2, "__esModule", { value: true }), e2.downloadWAV = function(t3, e3) {
        void 0 === e3 && (e3 = "recorder"), i2(t3, e3, "wav");
      }, e2.downloadPCM = function(t3, e3) {
        void 0 === e3 && (e3 = "recorder"), i2(t3, e3, "pcm");
      }, e2.download = function(t3, e3, n3) {
        return i2(t3, e3, n3);
      };
    }, function(t2, e2, n2) {
      Object.defineProperty(e2, "__esModule", { value: true });
      var i2 = n2(4), o2 = null, r2 = 0, a2 = 0, s2 = null, u2 = null, c2 = null, l2 = false, f2 = 0, p2 = function() {
      };
      function d2() {
        return l2 = false, s2.decodeAudioData(c2.slice(0), function(t3) {
          (o2 = s2.createBufferSource()).onended = function() {
            l2 || (f2 = s2.currentTime - a2 + r2, p2());
          }, o2.buffer = t3, o2.connect(u2), u2.connect(s2.destination), o2.start(0, r2), a2 = s2.currentTime;
        }, function(t3) {
          i2.throwError(t3);
        });
      }
      ...
      var y2 = function() {
        ...
        return t3.play = function(t4) {
          return s2 || (s2 = new (window.AudioContext || window.webkitAudioContext)(), (u2 = s2.createAnalyser()).fftSize = 2048), this.stopPlay(), c2 = t4, f2 = 0, d2();
        }, t3.pausePlay = function() {
          h2(), r2 += s2.currentTime - a2, l2 = true;
        }, t3.resumePlay = function() {
          return d2();
        }, t3.stopPlay = function() {
          r2 = 0, c2 = null, h2();
        }, t3.destroyPlay = function() {
          this.stopPlay();
        }, t3.getAnalyseData = function() {
          var t4 = new Uint8Array(u2.frequencyBinCount);
          return u2.getByteTimeDomainData(t4), t4;
        }, t3.addPlayEnd = function(t4) {
          void 0 === t4 && (t4 = function() {
          }), p2 = t4;
        }, t3.getPlayTime = function() {
          var t4 = l2 ? r2 : s2.currentTime - a2 + r2;
          return f2 || t4;
        }, t3;
      }();
      e2.default = y2;
    }, function(t2, e2, n2) {
      Object.defineProperty(e2, "__esModule", { value: true }), e2.throwError = function(t3) {
        throw new Error(t3);
      };
    }, function(t2, e2, n2) {
      Object.defineProperty(e2, "__esModule", { value: true });
      var i2 = n2(0), o2 = function() {
        function t3(e3) {
          void 0 === e3 && (e3 = {}), this.size = 0, this.lBuffer = [], this.rBuffer = [], this.tempPCM = [], this.inputSampleBits = 16, this.fileSize = 0, this.duration = 0, this.needRecord = true;
          var n3, i3 = new (window.AudioContext || window.webkitAudioContext)();
          this.inputSampleRate = i3.sampleRate, this.setNewOption(e3), this.littleEdian = (n3 = new ArrayBuffer(2), new DataView(n3).setInt16(0, 256, true), 256 === new Int16Array(n3)[0]), t3.initUserMedia();
        }
        return t3.prototype.setNewOption = function(t4) {
          void 0 === t4 && (t4 = {}), this.config = { sampleBits: ~[8, 16].indexOf(t4.sampleBits) ? t4.sampleBits : 16, sampleRate: ~[8e3, 11025, 16e3, 22050, 24e3, 44100, 48e3].indexOf(t4.sampleRate) ? t4.sampleRate : this.inputSampleRate, numChannels: ~[1, 2].indexOf(t4.numChannels) ? t4.numChannels : 1 }, this.outputSampleRate = this.config.sampleRate, this.oututSampleBits = this.config.sampleBits;
        }, t3.prototype.startRecord = function() {
          var t4 = this;
          return this.context && this.destroyRecord(), this.initRecorder(), navigator.mediaDevices.getUserMedia({ audio: true }).then(function(e3) {
            t4.audioInput = t4.context.createMediaStreamSource(e3), t4.stream = e3;
          }).then(function() {
            t4.audioInput.connect(t4.analyser), t4.analyser.connect(t4.recorder), t4.recorder.connect(t4.context.destination);
          });
        ...
        }, t3.prototype.destroyRecord = function() {
          return this.clearRecordStatus(), this.stopStream(), this.closeAudioContext();
        }, t3.prototype.getAnalyseData = function() {
          var t4 = new Uint8Array(this.analyser.frequencyBinCount);
          return this.analyser.getByteTimeDomainData(t4), t4;
        }, t3.prototype.getData = function() {
          return this.flat();
        }, t3.prototype.clearRecordStatus = function() {
        ...
        }, t3.prototype.flat = function() {
          var t4 = null, e3 = new Float32Array(0);
          1 === this.config.numChannels ? t4 = new Float32Array(this.size) : (t4 = new Float32Array(this.size / 2), e3 = new Float32Array(this.size / 2));
          for (var n3 = 0, i3 = 0; i3 < this.lBuffer.length; i3++)
            t4.set(this.lBuffer[i3], n3), n3 += this.lBuffer[i3].length;
          n3 = 0;
          for (i3 = 0; i3 < this.rBuffer.length; i3++)
            e3.set(this.rBuffer[i3], n3), n3 += this.rBuffer[i3].length;
          return { left: t4, right: e3 };
        }, t3.prototype.initRecorder = function() {
          var t4 = this;
          ...
          var e3 = this.context.createScriptProcessor || this.context.createJavaScriptNode;
          this.recorder = e3.apply(this.context, [4096, this.config.numChannels, this.config.numChannels]), this.recorder.onaudioprocess = function(e4) {
            if (t4.needRecord) {
              var n3, i3 = e4.inputBuffer.getChannelData(0), o3 = null;
              t4.lBuffer.push(new Float32Array(i3)), t4.size += i3.length, 2 === t4.config.numChannels && (o3 = e4.inputBuffer.getChannelData(1), t4.rBuffer.push(new Float32Array(o3)), t4.size += o3.length), t4.fileSize = Math.floor(t4.size / Math.max(t4.inputSampleRate / t4.outputSampleRate, 1)) * (t4.oututSampleBits / 8), n3 = 100 * Math.max.apply(Math, i3), t4.duration += 4096 / t4.inputSampleRate, t4.onprocess && t4.onprocess(t4.duration), t4.onprogress && t4.onprogress({ duration: t4.duration, fileSize: t4.fileSize, vol: n3 });
            }
          };
        }, t3.prototype.stopStream = function() {
          this.stream && this.stream.getTracks && (this.stream.getTracks().forEach(function(t4) {
            return t4.stop();
          }), this.stream = null);
        }, t3.prototype.closeAudioContext = function() {
          return this.context && this.context.close && "closed" !== this.context.state ? this.context.close() : new Promise(function(t4) {
            t4();
          });
        }, t3.initUserMedia = function() {
          void 0 === navigator.mediaDevices && (navigator.mediaDevices = {}), void 0 === navigator.mediaDevices.getUserMedia && (navigator.mediaDevices.getUserMedia = function(t4) {
            var e3 = navigator.getUserMedia || navigator.webkitGetUserMedia || navigator.mozGetUserMedia;
            return e3 ? new Promise(function(n3, i3) {
              e3.call(navigator, t4, n3, i3);
            }) : Promise.reject(new Error("浏览器不支持 getUserMedia !"));
          });
        }, t3.prototype.transformIntoPCM = function(t4, e3) {
          var n3 = new Float32Array(t4), o3 = new Float32Array(e3), r2 = i2.compress({ left: n3, right: o3 }, this.inputSampleRate, this.outputSampleRate);
          return i2.encodePCM(r2, this.oututSampleBits, this.littleEdian);
        }, t3.getPermission = function() {
          return this.initUserMedia(), navigator.mediaDevices.getUserMedia({ audio: true }).then(function(t4) {
            t4 && t4.getTracks().forEach(function(t5) {
              return t5.stop();
            });
          });
        }, t3;
...
const pages = [
  ...
  },
  {
    ...
    style: {
      navigationBarTitleText: "Carelink"
    }
  },
  {
    path: "pages/login/older",
    style: {
      navigationBarTitleText: "老人端"
    }
  },
  {
    path: "pages/login/young",
    style: {
      navigationBarTitleText: "子女端"
    }
  },
  {
    path: "pages/AI/AI",
  ...
  {
    path: "pages/young-index/index",
    style: {
      navigationBarTitleText: "医院智能推荐"
    }
  },
  {
    path: "pages/young-AI/AI",
    style: {
  ...
  list: [
    {
      ...
      iconPath: "static/older/home.png",
      selectedIconPath: "static/older/home_selected.png",
      text: "主页"
    },
    {
      pagePath: "pages/AI/AI",
      iconPath: "static/older/user.png",
      selectedIconPath: "static/older/user_selected.png",
      text: "我的"
    }
  ]
};

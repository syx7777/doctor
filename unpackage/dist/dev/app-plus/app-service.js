...
(function(vue, shared) {
  ...
  const _sfc_main$t = {
    __name: "user",
    setup(__props) {
      const profile_url = vue.ref(
        "https://ts1.cn.mm.bing.net/th/id/R-C.87e31573ecc8c23b96ae0d063a2d80f5?rik=0%2bIS%2b1ui2xO7rA&riu=http%3a%2f%2fimg.keaitupian.cn%2fuploads%2f2020%2f10%2f15%2f3bdbe46bb0fb42df9caca6d9df2a8c97.jpg&ehk=pPf%2bq9nVtQDoNE8M4n2OGd5i1oVEWQ6M1lBYSyN2IRI%3d&risl=&pid=ImgRaw&r=0"
      );
      const username = vue.ref("李雅春");
      const older = vue.ref("王云");
      const confirm = () => {
        uni.navigateTo({
          url: "/pages/medical-record/confirm"
        });
      };
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("view", { class: "container" }, [
          vue.createElementVNode("view", { class: "suspend" }, [
            vue.createElementVNode("view", { class: "profile" }, [
              profile_url.value ? (vue.openBlock(), vue.createElementBlock("image", {
                key: 0,
                src: profile_url.value,
                style: { "border-radius": "50%", "width": "150rpx", "height": "150rpx" }
            ...
            vue.createElementVNode("view", { class: "text-wrapper" }, [
              ...
              vue.createElementVNode(
                "view",
                { class: "oldername" },
                " 关怀老人：" + vue.toDisplayString(older.value),
                1
                /* TEXT */
              )
            ]),
            vue.createElementVNode("image", {
              src: "/static/young/icon_manage.png",
              style: { "width": "120rpx", "height": "120rpx", "margin-top": "20rpx" },
              onClick: confirm
            })
          ])
        ]);
  ...
  const user = /* @__PURE__ */ _export_sfc(_sfc_main$t, [["__scopeId", "data-v-13064efd"], ["__file", "D:/uni-app/eldoctor/pages/user.vue"]]);
  const _sfc_main$s = {
    name: "UniCard",
    emits: ["click"],
    props: {
  ...
  const __easycom_1$3 = /* @__PURE__ */ _export_sfc(_sfc_main$s, [["render", _sfc_render$h], ["__scopeId", "data-v-ae4bee67"], ["__file", "D:/uni-app/eldoctor/uni_modules/uni-card/components/uni-card/uni-card.vue"]]);
  ...
  const __easycom_0$2 = /* @__PURE__ */ _export_sfc(_sfc_main$r, [["render", _sfc_render$g], ["__scopeId", "data-v-d31e1c47"], ["__file", "D:/uni-app/eldoctor/uni_modules/uni-icons/components/uni-icons/uni-icons.vue"]]);
  let platform = "other";
  const _sfc_main$q = {
    name: "UniFab",
  ...
  const __easycom_1$2 = /* @__PURE__ */ _export_sfc(_sfc_main$q, [["render", _sfc_render$f], ["__scopeId", "data-v-85f34dfc"], ["__file", "D:/uni-app/eldoctor/uni_modules/uni-fab/components/uni-fab/uni-fab.vue"]]);
  const _sfc_main$p = {
    __name: "timing",
    setup(__props) {
      ...
      const timeList = vue.ref([
        {
          id: 0,
          title: "2023-10-4 00:00 至 2023-10-10 12：00",
          extra: "来自女儿",
          content: "吃药提醒"
        },
        {
      ...
      const add = () => {
        uni.navigateTo({
          url: "/pages/medical-record/information/add_timing"
        });
      };
      const edit = () => {
        uni.navigateTo({
      ...
      return (_ctx, _cache) => {
        const _component_uni_card = resolveEasycom(vue.resolveDynamicComponent("uni-card"), __easycom_1$3);
        const _component_uni_fab = resolveEasycom(vue.resolveDynamicComponent("uni-fab"), __easycom_1$2);
        return vue.openBlock(), vue.createElementBlock("view", { class: "container" }, [
          (vue.openBlock(true), vue.createElementBlock(
            vue.Fragment,
            null,
            vue.renderList(timeList.value, (item) => {
  ...
  const timing = /* @__PURE__ */ _export_sfc(_sfc_main$p, [["__file", "D:/uni-app/eldoctor/pages/medical-record/information/timing.vue"]]);
  const _sfc_main$o = {
    __name: "older-information",
    setup(__props) {
      const elder = vue.ref("王云");
      const value1 = vue.ref(false);
      const value2 = vue.ref(false);
      const value3 = vue.ref(false);
      const change1 = () => {
        value1.value = true;
        value2.value = true;
        value3.value = false;
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("view", { class: "container" }, [
          vue.createVNode(user),
          vue.createElementVNode("view", { class: "up" }, [
            vue.createElementVNode(
              "view",
              { class: "text" },
              vue.toDisplayString(elder.value),
              1
              /* TEXT */
            ),
            vue.createElementVNode("view", { class: "three" }, [
              vue.createElementVNode("view", { class: "img-wrapper" }, [
                value1.value == false ? (vue.openBlock(), vue.createElementBlock("image", {
                  key: 0,
                  src: "/static/young/icon/base.png",
                  onClick: change1,
                  class: "img"
                })) : vue.createCommentVNode("v-if", true),
                value1.value == true ? (vue.openBlock(), vue.createElementBlock("image", {
                  key: 1,
                  src: "/static/young/icon/selected-base.png",
                  onClick: change1,
                  class: "img"
                })) : vue.createCommentVNode("v-if", true),
                vue.createElementVNode("p", null, "基本信息")
              ]),
              vue.createElementVNode("view", { class: "img-wrapper" }, [
                value2.value == false ? (vue.openBlock(), vue.createElementBlock("image", {
                  key: 0,
                  src: "/static/young/icon/selected-medical.png",
                  onClick: change2,
                  class: "img"
                })) : vue.createCommentVNode("v-if", true),
                value2.value == true ? (vue.openBlock(), vue.createElementBlock("image", {
                  key: 1,
                  src: "/static/young/icon/medical.png",
                  onClick: change2,
                  class: "img"
                })) : vue.createCommentVNode("v-if", true),
                vue.createElementVNode("p", null, "病历信息")
              ]),
              vue.createElementVNode("view", { class: "img-wrapper" }, [
                value3.value == false ? (vue.openBlock(), vue.createElementBlock("image", {
                  key: 0,
                  src: "/static/young/icon/time.png",
                  onClick: change3,
                  class: "img"
                })) : vue.createCommentVNode("v-if", true),
                value3.value == true ? (vue.openBlock(), vue.createElementBlock("image", {
                  key: 1,
                  src: "/static/young/icon/selected-time.png",
                  onClick: change3,
                  class: "img"
                })) : vue.createCommentVNode("v-if", true),
                vue.createElementVNode("p", null, "定时任务")
              ])
            ])
          ]),
          value1.value ? (vue.openBlock(), vue.createElementBlock("view", {
            key: 0,
            class: "base"
          }, [
            vue.createElementVNode("button", { class: "btn" }, "设为关怀")
          ])) : vue.createCommentVNode("v-if", true),
          value2.value == false ? (vue.openBlock(), vue.createElementBlock("view", {
            key: 1,
            class: "medical"
          })) : vue.createCommentVNode("v-if", true),
          value3.value == true ? (vue.openBlock(), vue.createElementBlock("view", {
            key: 2,
            class: "time"
          }, [
            vue.createVNode(timing)
          ])) : vue.createCommentVNode("v-if", true)
        ]);
      };
    }
  };
  const PagesMedicalRecordOlderInformation = /* @__PURE__ */ _export_sfc(_sfc_main$o, [["__scopeId", "data-v-297a8927"], ["__file", "D:/uni-app/eldoctor/pages/medical-record/older-information.vue"]]);
  const _sfc_main$n = {
    __name: "index",
    setup(__props) {
      const timeList = vue.ref([
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("view", { class: "container" }, [
          vue.createElementVNode("view", { class: "center" }, [
            vue.createElementVNode("view", { class: "timeflex" }, [
              (vue.openBlock(true), vue.createElementBlock(
                vue.Fragment,
                null,
                vue.renderList(timeList.value, (time) => {
                  return vue.openBlock(), vue.createElementBlock("view", {
                    class: "time-wrapper",
                    key: time.id
                  }, [
            ...
            vue.createElementVNode("view", { class: "item" }, [
              (vue.openBlock(true), vue.createElementBlock(
                ...
                vue.renderList(cardList.value, (item) => {
                  return vue.openBlock(), vue.createElementBlock("view", {
                    class: "uni-card-wrapper",
                    key: item.id
                  }, [
                    vue.createElementVNode("view", { class: "card-up" }, [
                      ...
                      vue.createElementVNode("view", { class: "textwrapper" }, [
                        vue.createElementVNode(
                          "view",
                          { class: "text1" },
                          vue.toDisplayString(item.text),
                        ...
                        vue.createCommentVNode(' <view class="text2">\r\n								{{item.time}}\r\n							</view> ')
                      ])
                    ]),
                    vue.createElementVNode("view", { class: "linewrapper" }, [
                      vue.createElementVNode("view", { class: "line" })
                    ]),
                    vue.createElementVNode("view", { class: "card-down" }, [
                      vue.createCommentVNode(' <view class="distance">\r\n							<uni-icons class="icon" color="#FFFFFF" type="location" size="50rpx"></uni-icons>\r\n							{{item.distance}}\r\n						</view> '),
                      vue.createElementVNode(
                        "view",
                        { class: "text2" },
                      ...
                      vue.createElementVNode(
                        "view",
                        { class: "person" },
                        vue.toDisplayString(item.person),
                        1
                        /* TEXT */
                      )
                    ])
  ...
  const PagesIndexIndex = /* @__PURE__ */ _export_sfc(_sfc_main$n, [["__scopeId", "data-v-1cf27b2a"], ["__file", "D:/uni-app/eldoctor/pages/index/index.vue"]]);
  const _sfc_main$m = {
    __name: "login",
    setup(__props) {
      const change1 = () => {
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("view", { class: "container" }, [
          ...
          vue.createElementVNode("view", { class: "content" }, [
            vue.createElementVNode("view", { class: "bigtitle" }, [
              vue.createElementVNode("p", null, "请选择您的身份信息！")
            ]),
            vue.createElementVNode("view", {
              class: "older_card",
              onClick: _cache[0] || (_cache[0] = ($event) => change1())
            }, [
              vue.createElementVNode("image", {
                class: "img_old",
                src: " ../../static/older.png",
                mode: "widthFix"
              }),
              vue.createElementVNode("view", { class: "word1" }, [
                vue.createElementVNode("view", { class: "round1" }),
                vue.createElementVNode("p", null, "长辈模式")
              ]),
              vue.createCommentVNode(' <view class="round1"></view> ')
            ]),
            vue.createElementVNode("view", {
              class: "young_card",
              onClick: _cache[1] || (_cache[1] = ($event) => change2())
            }, [
              vue.createElementVNode("view", { class: "word2" }, [
                vue.createElementVNode("view", { class: "round2" }),
                vue.createElementVNode("p", null, "子女模式")
              ]),
              vue.createElementVNode("image", {
                class: "img_young",
                src: "/static/young.png",
                mode: "widthFix"
              })
            ])
          ])
  ...
  const PagesLoginLogin = /* @__PURE__ */ _export_sfc(_sfc_main$m, [["__scopeId", "data-v-e4e4508d"], ["__file", "D:/uni-app/eldoctor/pages/login/login.vue"]]);
  const _sfc_main$l = {};
    ...
    return vue.openBlock(), vue.createElementBlock("view", { class: "contanier" }, [
      ...
      vue.createElementVNode("view", { class: "content" }, [
        vue.createElementVNode("view", { class: "word1" }, [
          ...
          vue.createElementVNode("p", { class: "word2" }, "欢迎您！")
        ]),
        vue.createElementVNode("image", {
          class: "img1",
          src: "/static/older/erWeiMa_1.png",
          mode: "widthFix"
        }),
        vue.createElementVNode("p", { class: "word3" }, "子女端扫码进入您的APP")
      ])
    ]);
  }
  const PagesLoginOlder = /* @__PURE__ */ _export_sfc(_sfc_main$l, [["render", _sfc_render$e], ["__scopeId", "data-v-7425e12f"], ["__file", "D:/uni-app/eldoctor/pages/login/older.vue"]]);
  ...
  const __easycom_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$k, [["render", _sfc_render$d], ["__scopeId", "data-v-09fd5285"], ["__file", "D:/uni-app/eldoctor/uni_modules/uni-easyinput/components/uni-easyinput/uni-easyinput.vue"]]);
  const _sfc_main$j = {
    name: "uniFormsItem",
    options: {
      virtualHost: true
  ...
  const __easycom_1$1 = /* @__PURE__ */ _export_sfc(_sfc_main$j, [["render", _sfc_render$c], ["__scopeId", "data-v-462874dd"], ["__file", "D:/uni-app/eldoctor/uni_modules/uni-forms/components/uni-forms-item/uni-forms-item.vue"]]);
  var pattern = {
    email: /^\S+?@\S+?\.\S+?$/,
  ...
  const __easycom_2$2 = /* @__PURE__ */ _export_sfc(_sfc_main$i, [["render", _sfc_render$b], ["__scopeId", "data-v-9a1e3c32"], ["__file", "D:/uni-app/eldoctor/uni_modules/uni-forms/components/uni-forms/uni-forms.vue"]]);
  const _sfc_main$h = {
    data() {
      return {
        // 表单数据
    ...
    methods: {
      ...
      submit() {
        this.$refs.form.validate().then((res) => {
          formatAppLog("log", "at pages/login/young.vue:89", "表单数据信息：", res);
          uni.redirectTo({
            // url: '/pages/medical-record/record'
            url: "/pages/index/index"
          });
        }).catch((err) => {
          formatAppLog("log", "at pages/login/young.vue:95", "表单错误信息：", err);
        });
      }
    }
  };
  function _sfc_render$a(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createElementBlock("view", { class: "container" }, [
        ...
        vue.createVNode(_component_uni_card, {
          ...
          default: vue.withCtx(() => [
            ...
            vue.createElementVNode("button", {
              ...
              style: { "background-color": "#042259", "color": "aliceblue" }
            }, " 登录 "),
            vue.createElementVNode("view", null, [
              vue.createElementVNode("a", { class: "word" }, "忘记密码")
            ])
          ]),
          _: 1
          /* STABLE */
      ...
      vue.createElementVNode("view", { class: "bottom" }, [
        vue.createElementVNode("a", { class: "word" }, "创建您的账号")
      ])
    ]);
  }
  const PagesLoginYoung = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["render", _sfc_render$a], ["__file", "D:/uni-app/eldoctor/pages/login/young.vue"]]);
    ...
    !function(t2, e) {
      ...
      return function(t2) {
        ...
        function n2(i2) {
          if (e[i2])
            return e[i2].exports;
          var o2 = e[i2] = { i: i2, l: false, exports: {} };
          return t2[i2].call(o2.exports, o2, o2.exports, n2), o2.l = true, o2.exports;
        }
        return n2.m = t2, n2.c = e, n2.d = function(t3, e2, i2) {
          n2.o(t3, e2) || Object.defineProperty(t3, e2, { enumerable: true, get: i2 });
        }, n2.r = function(t3) {
          ...
          if (n2.r(i2), Object.defineProperty(i2, "default", { enumerable: true, value: t3 }), 2 & e2 && "string" != typeof t3)
            for (var o2 in t3)
              n2.d(i2, o2, function(e3) {
                return t3[e3];
              }.bind(null, o2));
          return i2;
        }, n2.n = function(t3) {
        ...
        function i2(t3, e2, n3) {
          for (var i3 = 0; i3 < n3.length; i3++)
            t3.setUint8(e2 + i3, n3.charCodeAt(i3));
        }
        Object.defineProperty(e, "__esModule", { value: true }), e.compress = function(t3, e2, n3) {
          for (var i3 = e2 / n3, o2 = Math.max(i3, 1), r2 = t3.left, a2 = t3.right, s2 = Math.floor((r2.length + a2.length) / i3), u2 = new Float32Array(s2), c2 = 0, l2 = 0; c2 < s2; ) {
            var f2 = Math.floor(l2);
            u2[c2] = r2[f2], c2++, a2.length && (u2[c2] = a2[f2], c2++), l2 += o2;
          }
          return u2;
        }, e.encodePCM = function(t3, e2, n3) {
          void 0 === n3 && (n3 = true);
          var i3 = 0, o2 = t3.length * (e2 / 8), r2 = new ArrayBuffer(o2), a2 = new DataView(r2);
          if (8 === e2)
          ...
          return a2;
        }, e.encodeWAV = function(t3, e2, n3, o2, r2, a2) {
          void 0 === a2 && (a2 = true);
          var s2 = n3 > e2 ? e2 : n3, u2 = r2, c2 = new ArrayBuffer(44 + t3.byteLength), l2 = new DataView(c2), f2 = o2, p2 = 0;
        ...
        var i2, o2 = this && this.__extends || (i2 = function(t3, e2) {
          return (i2 = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(t4, e3) {
            t4.__proto__ = e3;
          } || function(t4, e3) {
            for (var n3 in e3)
          ...
          i2(t3, e2), t3.prototype = null === e2 ? Object.create(e2) : (n3.prototype = e2.prototype, new n3());
        });
        Object.defineProperty(e, "__esModule", { value: true });
        var r2 = n2(2), a2 = n2(0), s2 = n2(3), u2 = function(t3) {
          function e2(e3) {
            void 0 === e3 && (e3 = {});
            var n3 = t3.call(this, e3) || this;
            return n3.isrecording = false, n3.ispause = false, n3.isplaying = false, n3;
          }
          return o2(e2, t3), e2.prototype.setOption = function(t4) {
          ...
          }, e2.prototype.downloadPCM = function(t4) {
            void 0 === t4 && (t4 = "recorder");
            var e3 = this.getPCMBlob();
            r2.downloadPCM(e3, t4);
          ...
          }, e2.prototype.downloadWAV = function(t4) {
            void 0 === t4 && (t4 = "recorder");
            var e3 = this.getWAVBlob();
            r2.downloadWAV(e3, t4);
          }, e2.prototype.download = function(t4, e3, n3) {
            r2.download(t4, e3, n3);
          }, e2.prototype.getChannelData = function() {
            var t4 = this.getPCM(), e3 = t4.byteLength, n3 = this.littleEdian, i3 = { left: null, right: null };
            if (2 === this.config.numChannels) {
              var o3 = new DataView(new ArrayBuffer(e3 / 2)), r3 = new DataView(new ArrayBuffer(e3 / 2));
              if (16 === this.config.sampleBits)
                for (var a3 = 0; a3 < e3 / 2; a3 += 2)
                  o3.setInt16(a3, t4.getInt16(2 * a3, n3), n3), r3.setInt16(a3, t4.getInt16(2 * a3 + 2, n3), n3);
              else
                for (a3 = 0; a3 < e3 / 2; a3 += 2)
        ...
        function i2(t3, e2, n3) {
          ...
          i3.href = window.URL.createObjectURL(t3), i3.download = e2 + "." + n3, i3.click();
        }
        Object.defineProperty(e, "__esModule", { value: true }), e.downloadWAV = function(t3, e2) {
          void 0 === e2 && (e2 = "recorder"), i2(t3, e2, "wav");
        }, e.downloadPCM = function(t3, e2) {
          void 0 === e2 && (e2 = "recorder"), i2(t3, e2, "pcm");
        }, e.download = function(t3, e2, n3) {
          return i2(t3, e2, n3);
        };
      }, function(t2, e, n2) {
        Object.defineProperty(e, "__esModule", { value: true });
        ...
        Object.defineProperty(e, "__esModule", { value: true }), e.throwError = function(t3) {
          throw new Error(t3);
        };
      }, function(t2, e, n2) {
        Object.defineProperty(e, "__esModule", { value: true });
        var i2 = n2(0), o2 = function() {
          function t3(e2) {
            ...
            this.inputSampleRate = i3.sampleRate, this.setNewOption(e2), this.littleEdian = (n3 = new ArrayBuffer(2), new DataView(n3).setInt16(0, 256, true), 256 === new Int16Array(n3)[0]), t3.initUserMedia();
          }
          return t3.prototype.setNewOption = function(t4) {
            ...
            return this.context && this.destroyRecord(), this.initRecorder(), navigator.mediaDevices.getUserMedia({ audio: true }).then(function(e2) {
              t4.audioInput = t4.context.createMediaStreamSource(e2), t4.stream = e2;
            }).then(function() {
            ...
            var t4 = null, e2 = new Float32Array(0);
            1 === this.config.numChannels ? t4 = new Float32Array(this.size) : (t4 = new Float32Array(this.size / 2), e2 = new Float32Array(this.size / 2));
            ...
            for (i3 = 0; i3 < this.rBuffer.length; i3++)
              e2.set(this.rBuffer[i3], n3), n3 += this.rBuffer[i3].length;
            return { left: t4, right: e2 };
            ...
            this.recorder = e2.apply(this.context, [4096, this.config.numChannels, this.config.numChannels]), this.recorder.onaudioprocess = function(e3) {
              if (t4.needRecord) {
                var n3, i3 = e3.inputBuffer.getChannelData(0), o3 = null;
                t4.lBuffer.push(new Float32Array(i3)), t4.size += i3.length, 2 === t4.config.numChannels && (o3 = e3.inputBuffer.getChannelData(1), t4.rBuffer.push(new Float32Array(o3)), t4.size += o3.length), t4.fileSize = Math.floor(t4.size / Math.max(t4.inputSampleRate / t4.outputSampleRate, 1)) * (t4.oututSampleBits / 8), n3 = 100 * Math.max.apply(Math, i3), t4.duration += 4096 / t4.inputSampleRate, t4.onprocess && t4.onprocess(t4.duration), t4.onprogress && t4.onprogress({ duration: t4.duration, fileSize: t4.fileSize, vol: n3 });
              }
            };
            ...
            void 0 === navigator.mediaDevices && (navigator.mediaDevices = {}), void 0 === navigator.mediaDevices.getUserMedia && (navigator.mediaDevices.getUserMedia = function(t4) {
              ...
              return e2 ? new Promise(function(n3, i3) {
                e2.call(navigator, t4, n3, i3);
              }) : Promise.reject(new Error("浏览器不支持 getUserMedia !"));
            });
          }, t3.prototype.transformIntoPCM = function(t4, e2) {
            var n3 = new Float32Array(t4), o3 = new Float32Array(e2), r2 = i2.compress({ left: n3, right: o3 }, this.inputSampleRate, this.outputSampleRate);
  ...
  const _sfc_main$g = {
	...
	总的来说，番茄和鸡蛋是非常兼容的食材，可以根据个人口味和食材的可用性制作各种不同的美食。无论是炒、煮、夹在三明治里还是混合在面食中，这两者的组合都可以提供丰富的风味和营养。`
      ...
      const types2 = vue.ref(true);
      const change = () => {
        types2.value = !types2.value;
      };
      const data = vue.reactive({
        ...
        submit() {
          data.recorder.pause();
          data.timer = null;
          formatAppLog("log", "at pages/AI/AI.vue:76", "上传录音");
          ...
          formatAppLog("log", "at pages/AI/AI.vue:88", data.duration);
          sendAudio(formData).then((res) => {
            formatAppLog("log", "at pages/AI/AI.vue:91", res);
          });
        },
        // 录音按钮的点击事件
        voice() {
          ...
          Recorder.getPermission().then(() => {
            formatAppLog("log", "at pages/AI/AI.vue:105", "开始录音");
            data.recorder.start();
          }, (error) => {
            formatAppLog("log", "at pages/AI/AI.vue:108", `${error.name} : ${error.message}`);
          });
        },
        handleStop() {
          formatAppLog("log", "at pages/AI/AI.vue:112", "停止录音");
          data.recorder.stop();
          data.mation = false;
        },
        handlePlay() {
          formatAppLog("log", "at pages/AI/AI.vue:117", "播放录音");
          data.recorder.play();
        },
        handleDestroy() {
          formatAppLog("log", "at pages/AI/AI.vue:121", "销毁实例");
          if (data.recorder) {
      ...
      return (_ctx, _cache) => {
        ...
        return vue.openBlock(), vue.createElementBlock("view", { class: "container" }, [
            ...
            vue.renderList(log.value, (word) => {
              return vue.openBlock(), vue.createElementBlock("view", {
                ...
                vue.createElementVNode(
                  "view",
                  { class: "white" },
                  vue.toDisplayString(word.prompt),
                  1
                  /* TEXT */
                ),
                vue.createElementVNode(
                  "view",
                  { class: "blue" },
                  vue.toDisplayString(word.reply),
                  1
                  /* TEXT */
                )
              ]);
          ...
          vue.createElementVNode("view", { class: "input" }, [
            types2.value == false ? (vue.openBlock(), vue.createElementBlock("view", {
              key: 0,
              class: "keyboard"
            }, [
            ...
            types2.value == true ? (vue.openBlock(), vue.createElementBlock("view", {
              key: 1,
              class: "audio"
            }, [
              vue.createElementVNode("i", {
              ...
              vue.createElementVNode("button", {
                onClick: _cache[1] || (_cache[1] = (...args) => _ctx.voice && _ctx.voice(...args)),
                disabled: _ctx.isRecording,
                style: { "width": "80%" }
              }, "请按住说话", 8, ["disabled"]),
              vue.createCommentVNode(' <div class="audio-animation" :class="{ active: isRecording }"></div> ')
            ])) : vue.createCommentVNode("v-if", true)
          ])
        ]);
      };
  ...
  const PagesAIAI = /* @__PURE__ */ _export_sfc(_sfc_main$g, [["__scopeId", "data-v-e2f8c5c5"], ["__file", "D:/uni-app/eldoctor/pages/AI/AI.vue"]]);
  const _sfc_main$f = {
  ...
  const __easycom_0 = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["render", _sfc_render$9], ["__scopeId", "data-v-86aa1171"], ["__file", "D:/uni-app/eldoctor/uni_modules/uni-segmented-control/components/uni-segmented-control/uni-segmented-control.vue"]]);
  const _sfc_main$e = {
    name: "uniGroup",
    emits: ["click"],
    props: {
  ...
  const __easycom_1 = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["render", _sfc_render$8], ["__scopeId", "data-v-210c3f0c"], ["__file", "D:/uni-app/eldoctor/uni_modules/uni-group/components/uni-group/uni-group.vue"]]);
  const _sfc_main$d = {
    name: "UniSection",
    emits: ["click"],
    props: {
  ...
  const __easycom_2$1 = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["render", _sfc_render$7], ["__scopeId", "data-v-637fd36b"], ["__file", "D:/uni-app/eldoctor/uni_modules/uni-section/components/uni-section/uni-section.vue"]]);
  ...
  const pages = [
    {
      path: "pages/medical-record/older-information",
      style: {
    ...
    {
      path: "pages/medical-record/information/add_timing",
      style: {
        navigationBarTitleText: "添加定时任务"
      }
    },
    {
      path: "pages/medical-record/confirm",
      style: {
        navigationBarTitleText: "老人端信息"
      }
    },
    {
...
详细信息：${s4}`), r3(i3);
  ...
  const __easycom_3 = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["render", _sfc_render$6], ["__scopeId", "data-v-20df4ef0"], ["__file", "D:/uni-app/eldoctor/uni_modules/uni-list/components/uni-list-chat/uni-list-chat.vue"]]);
  const _sfc_main$b = {
    name: "uniList",
    "mp-weixin": {
      options: {
  ...
  const __easycom_5 = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["render", _sfc_render$5], ["__scopeId", "data-v-c2f1266a"], ["__file", "D:/uni-app/eldoctor/uni_modules/uni-list/components/uni-list/uni-list.vue"]]);
  const _sfc_main$a = {
    __name: "tabBar",
    setup(__props) {
      const index1 = vue.ref(0);
      const index2 = vue.ref(1);
      const index3 = vue.ref(0);
      const tabBar_index = () => {
        index1.value = 0;
        uni.navigateTo({
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("view", { class: "container" }, [
          vue.createElementVNode("view", { class: "tabBar" }, [
            vue.createElementVNode("view", {
              onClick: tabBar_index,
              class: "bar"
            }, [
              index1.value == 0 ? (vue.openBlock(), vue.createElementBlock("image", {
                key: 0,
                src: "/static/young/index.png",
                mode: "widthFix",
                class: "img"
              })) : vue.createCommentVNode("v-if", true),
              index1.value == 1 ? (vue.openBlock(), vue.createElementBlock("image", {
                key: 1,
                src: "/static/young/index-selected.png",
                class: "img"
              })) : vue.createCommentVNode("v-if", true),
              vue.createElementVNode("view", null, "首页")
            ]),
            vue.createElementVNode("view", {
              onClick: tabBar_record,
              class: "bar"
            }, [
              index2.value == 0 ? (vue.openBlock(), vue.createElementBlock("image", {
                key: 0,
                src: "/static/young/record.png",
                class: "img"
              })) : vue.createCommentVNode("v-if", true),
              index2.value == 1 ? (vue.openBlock(), vue.createElementBlock("image", {
                key: 1,
                src: "/static/young/record-selected.png",
                class: "img"
              })) : vue.createCommentVNode("v-if", true),
              vue.createElementVNode("view", null, "老人病历")
            ]),
            vue.createElementVNode("view", {
              onClick: tabBar_AI,
              class: "bar"
            }, [
              index3.value == 0 ? (vue.openBlock(), vue.createElementBlock("image", {
                key: 0,
                src: "/static/young/dialog.png",
                class: "img"
              })) : vue.createCommentVNode("v-if", true),
              index3.value == 1 ? (vue.openBlock(), vue.createElementBlock("image", {
                key: 1,
                src: "/static/young/dialog-selected.png",
                class: "img"
              })) : vue.createCommentVNode("v-if", true),
              vue.createElementVNode("view", null, "AI对话")
            ])
          ])
        ]);
      };
  ...
  const tabBar1 = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["__scopeId", "data-v-d18195fd"], ["__file", "D:/uni-app/eldoctor/pages/tabBar.vue"]]);
  const _sfc_main$9 = {
    __name: "index",
    setup(__props) {
      const items = vue.ref(["综合", "距离", "好评"]);
      const current = vue.ref(0);
      const phone = vue.ref("010-2348909");
      const location2 = vue.ref("北京市朝阳区樱花园东街2号");
      const onClickItem = (e) => {
      ...
      return (_ctx, _cache) => {
        ...
        const _component_uni_group = resolveEasycom(vue.resolveDynamicComponent("uni-group"), __easycom_1);
        const _component_uni_section = resolveEasycom(vue.resolveDynamicComponent("uni-section"), __easycom_2$1);
        const _component_uni_list_chat = resolveEasycom(vue.resolveDynamicComponent("uni-list-chat"), __easycom_3);
        const _component_uni_icons = resolveEasycom(vue.resolveDynamicComponent("uni-icons"), __easycom_0$2);
        ...
        return vue.openBlock(), vue.createElementBlock("view", { class: "container" }, [
          ...
          vue.createElementVNode("view", { class: "card" }, [
            vue.createElementVNode("image", {
              src: "/static/young/hospital1.png",
              mode: "widthFix",
              class: "img1"
            })
          ]),
          vue.createElementVNode("view", { class: "list-wrapper" }, [
            vue.createElementVNode("view", { class: "list1" }, [
              vue.createVNode(_component_uni_section, {
                ...
                default: vue.withCtx(() => [
                  vue.createVNode(_component_uni_group, { mode: "card" }, {
                    default: vue.withCtx(() => [
                      vue.createElementVNode(
                        "view",
                        null,
                        " 医院电话：" + vue.toDisplayString(phone.value),
                        1
                        /* TEXT */
                      ),
                      vue.createElementVNode(
                        "view",
                        null,
                        " 医院地址：" + vue.toDisplayString(location2.value),
                        1
                        /* TEXT */
                      ),
                      vue.createElementVNode("view", null, [
                        vue.createElementVNode("image", {
                          src: "/static/young/map.png",
                          mode: "widthFix",
                          class: "img"
                        })
                      ])
            ...
            vue.createElementVNode("view", { class: "list2" }, [
              vue.createVNode(_component_uni_section, {
                title: "医生信息",
                type: "line"
              }, {
          ...
          vue.createElementVNode("view", { class: "rule" }, [
            vue.createElementVNode("span", null, "预约规则")
          ]),
          vue.createElementVNode("view", { class: "down" }, [
            vue.createVNode(tabBar1)
          ])
        ]);
      };
    }
  };
  const PagesYoungIndexIndex = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-8735e056"], ["__file", "D:/uni-app/eldoctor/pages/young-index/index.vue"]]);
  const _sfc_main$8 = {
    __name: "record",
    setup(__props) {
      const cardInformation = vue.ref({
        call: "妈妈",
        name: "王云",
        symptom: ["高血压", "劲椎病", "腰间盘突出"]
      });
      const information = vue.ref([
        {
          id: 1,
          call: "岳父",
          name: "张强",
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("view", { class: "container" }, [
          vue.createElementVNode("view", { class: "up" }, [
            vue.createElementVNode("view", { class: "fontE" }, "Welcome back"),
            vue.createElementVNode("view", { class: "olderListText" }, "老人列表"),
              ...
              vue.createElementVNode("view", {
                ...
                vue.createElementVNode("view", { class: "text" }, [
                  vue.createElementVNode(
                    "p",
                    { class: "card-word1" },
                    vue.toDisplayString(cardInformation.value.call),
                    1
                    /* TEXT */
                  ),
                  vue.createElementVNode(
                    "p",
                    { class: "card-word2" },
                    vue.toDisplayString(cardInformation.value.name),
                    1
                    /* TEXT */
                  ),
                  vue.createElementVNode("view", { class: "tag-wrapper" }, [
                    (vue.openBlock(true), vue.createElementBlock(
                      vue.Fragment,
                      null,
                      vue.renderList(cardInformation.value.symptom, (symptom) => {
                        return vue.openBlock(), vue.createElementBlock(
                          "p",
                          { class: "card-tag" },
                          vue.toDisplayString(symptom),
                          1
                          /* TEXT */
                        );
                      }),
                ...
                vue.createElementVNode("view", { class: "card-round" }, [
                  vue.createElementVNode("view", { class: "card-round-mini" })
                ])
              ]),
              vue.createElementVNode("button", {
                class: "button",
          ...
          vue.createElementVNode("view", { class: "center" }, [
            vue.createElementVNode("p", { class: "other-olders" }, "其他老人"),
            (vue.openBlock(true), vue.createElementBlock(
              vue.Fragment,
              null,
              vue.renderList(information.value, (item, index) => {
                return vue.openBlock(), vue.createElementBlock("view", {
                  class: "other-cards",
                  onClick: enter
                }, [
                  ...
                  vue.createElementVNode(
                    "p",
                    { class: "card-word3" },
                    vue.toDisplayString(item.symptom),
                    1
                    /* TEXT */
                  )
                ]);
  ...
  const PagesMedicalRecordRecord = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-54383971"], ["__file", "D:/uni-app/eldoctor/pages/medical-record/record.vue"]]);
  ...
  const calendarItem = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render$4], ["__scopeId", "data-v-3c762a01"], ["__file", "D:/uni-app/eldoctor/uni_modules/uni-datetime-picker/components/uni-datetime-picker/calendar-item.vue"]]);
  const en = {
  ...
  const TimePicker = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$3], ["__scopeId", "data-v-1d532b70"], ["__file", "D:/uni-app/eldoctor/uni_modules/uni-datetime-picker/components/uni-datetime-picker/time-picker.vue"]]);
  ...
  const Calendar = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$2], ["__scopeId", "data-v-1d379219"], ["__file", "D:/uni-app/eldoctor/uni_modules/uni-datetime-picker/components/uni-datetime-picker/calendar.vue"]]);
  const _sfc_main$4 = {
    name: "UniDatetimePicker",
    options: {
      virtualHost: true
  ...
  const __easycom_2 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$1], ["__scopeId", "data-v-9802168a"], ["__file", "D:/uni-app/eldoctor/uni_modules/uni-datetime-picker/components/uni-datetime-picker/uni-datetime-picker.vue"]]);
  const _sfc_main$3 = {
    __name: "add_timing",
    setup(__props) {
      const value = vue.ref("");
      const datetimerange = vue.ref([]);
      const input = (e) => {
        formatAppLog("log", "at pages/medical-record/information/add_timing.vue:25", "输入内容：", e);
      };
      return (_ctx, _cache) => {
        const _component_uni_easyinput = resolveEasycom(vue.resolveDynamicComponent("uni-easyinput"), __easycom_0$1);
        const _component_uni_card = resolveEasycom(vue.resolveDynamicComponent("uni-card"), __easycom_1$3);
        ...
        return vue.openBlock(), vue.createElementBlock("view", { class: "container" }, [
            ...
            default: vue.withCtx(() => [
              vue.createElementVNode("view", { class: "example-body" }, [
                vue.createVNode(_component_uni_datetime_picker, {
                  ...
                  "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => datetimerange.value = $event),
                  type: "datetimerange",
                  rangeSeparator: "至"
                }, null, 8, ["modelValue"])
              ])
          ...
          vue.createElementVNode("button", { class: "btn" }, "保存")
        ]);
      };
    }
  };
  const PagesMedicalRecordInformationAdd_timing = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-423f24bb"], ["__file", "D:/uni-app/eldoctor/pages/medical-record/information/add_timing.vue"]]);
  const _sfc_main$2 = {};
  function _sfc_render(_ctx, _cache) {
    return null;
  }
  const PagesMedicalRecordConfirm = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render], ["__file", "D:/uni-app/eldoctor/pages/medical-record/confirm.vue"]]);
  const _sfc_main$1 = {
    __name: "AI",
    setup(__props) {
      const log = vue.ref([
  ...
  const PagesYoungAIAI = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-5064934a"], ["__file", "D:/uni-app/eldoctor/pages/young-AI/AI.vue"]]);
  __definePage("pages/medical-record/older-information", PagesMedicalRecordOlderInformation);
  __definePage("pages/index/index", PagesIndexIndex);
  __definePage("pages/login/login", PagesLoginLogin);
  __definePage("pages/login/older", PagesLoginOlder);
  __definePage("pages/login/young", PagesLoginYoung);
  __definePage("pages/AI/AI", PagesAIAI);
  __definePage("pages/young-index/index", PagesYoungIndexIndex);
  __definePage("pages/medical-record/record", PagesMedicalRecordRecord);
  __definePage("pages/medical-record/information/add_timing", PagesMedicalRecordInformationAdd_timing);
  __definePage("pages/medical-record/confirm", PagesMedicalRecordConfirm);
  __definePage("pages/young-AI/AI", PagesYoungAIAI);
  const _sfc_main = {
    onLaunch: function() {
  ...
  const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "D:/uni-app/eldoctor/App.vue"]]);
  function createApp() {
